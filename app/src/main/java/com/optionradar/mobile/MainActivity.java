...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        TextView footer = text("OptionRadar Android v0.4 Native KLine｜純監看", 11, C_MUTED, false);
    ...
    private void showServerSettings() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("輸入電腦端 OptionRadar 的 Tailscale IP 與 Port。\n主畫面讀 /api/mobile/snapshot；原生K線獨立讀 /api/mobile/klines。")
                .setView(box)
                .setPositiveButton("儲存並連線", (dialog, which) -> {
                    ...
                    resetKlineViewport = true;
                    kickPollersNow();
                    Toast.makeText(this, "已儲存，開始原生 Dashboard + K線連線", Toast.LENGTH_SHORT).show();
                })
